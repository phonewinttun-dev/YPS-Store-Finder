...
const defaultTranslations: Record<Language, TranslationData> = {
  my: {
    ...
    showBusLines: "ရောက်နိုင်သော ယာဉ်လိုင်းများကြည့်ရန်",
    showAllStores: "ဆိုင်အားလုံးကိုကြည့်မယ်",
    ybsBusLines: "YBS ယာဉ်လိုင်းများ",
    ypsCardAccepted: "YPS ကတ် ရရှိနိုင်သည်",
    allBusLines: "ယာဉ်လိုင်း အားလုံး",
    ypsOnlyLines: "YPS ရသော ယာဉ်လိုင်းများ",
    outboundRoute: "အသွား လမ်းကြောင်း",
    returnRoute: "အပြန် လမ်းကြောင်း",
